...
import { properties } from './ApifyNaver.properties';
import { runActor } from './helpers/executeActor';

// SNIPPET 1: Make sure the constants are correct
export const ACTOR_ID = 'j4OJsjSUT8rK1REX6' as string;

export const PACKAGE_NAME = 'n8n-nodes-naver-search-api' as string;
export const CLASS_NAME = 'ApifyNaver' as string;
...
export const X_PLATFORM_APP_HEADER_ID = 'naver-search-app' as string;

export const DISPLAY_NAME = 'Naver Search' as string;
export const DESCRIPTION =
	'Search Naver (web, news, images, video, shopping) and return titles, links, and snippets' as string;

export class ApifyNaver implements INodeType {
